<div class="mb-8 flex gap-1 border-b border-slate-200">
    ...
    <a href="{{ route('admin.pcs.index') }}"
        class="border-b-2 px-4 py-2 text-sm font-medium transition {{ request()->routeIs('admin.pcs.*') ? 'border-slate-900 text-slate-900' : 'border-transparent text-slate-500 hover:text-slate-700' }}">
        PCs
    </a>
